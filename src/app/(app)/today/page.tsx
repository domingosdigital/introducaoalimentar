          ...
          <Card key={mealName} className="shadow-sm">
            ...
            <CardContent>
              <p className="text-muted-foreground text-base leading-relaxed">
                <span className="font-semibold text-foreground">Preparo:</span> {suggestion.preparation}
              </p>
              <p className="text-muted-foreground text-base mt-2">
                <span className="font-semibold text-foreground">Textura:</span> {suggestion.texture}
              </p>
            </CardContent>
          </Card>
        ))}
